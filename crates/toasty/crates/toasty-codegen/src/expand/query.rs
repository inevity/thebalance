    ...
    pub(super) fn expand_query_struct(&self) -> TokenStream {
        ...
        quote! {
            ...
            impl #query_struct_ident {
                ...
                #vis fn limit(mut self, limit: impl #toasty::IntoExpr<i64>) -> #query_struct_ident {
                    self.stmt.limit(limit.into_expr());
                    self
                }

                #vis fn offset(mut self, offset: impl #toasty::IntoExpr<i64>) -> #query_struct_ident {
                    self.stmt.offset(offset.into_expr());
                    self
                }
